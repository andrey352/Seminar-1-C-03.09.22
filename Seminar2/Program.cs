...
// 23.09.22   Семинар 8. Двухмерные массивы, продолжение.
...
// 27.09.22  Семинар №8    рекурсия

// Упорядочим одномерный массив по уменьшению пузырьковым способом
...
// int[] array = new int [] {2, 5, 2, 15, 43, 32, 43, 6};
...
// Заполним масив неповторющимися числами
...
//         if (SearchElem(array, temp))            // если эл-т temp есть, то SearchElem вернет true, и if сработает
//         {
//             continue;                           // завершит работу цикла на этом моменте, перейдет в начало цикла
//         }
//         else
//         {
//             array[i] = temp;                   // заносит temp в массив
//             flag = true;                       // flag нужен что бы выйти из цикла и продолжить заполнять след эл-ты
//         }        
//     }
// }
...
//  вывести факториал числа через рекурсию
...
// Зад 63. задайте значение N. Напишите прогр, к-я выведет все натуральные числа в промежутке от 1 до N.
// N = 5 -> 1,2,3,4,5

// string NaturDigit (int n)
// {
//     if (n == 1)
//     {
//         return "1";
...
//     string res = n + " " + NaturDigit(n-1);
    
//     return res;
// }
// string result = NaturDigit(5);
// Console.WriteLine(result);

// Зад 65. Задайте значения M и N. Напишите прогр, к-я выведет все натур числа от M N

// string NaturDigit (int m, int n)
// {
//     if (m == n)
//     {
//         return $"{m}";
...
//     string res = NaturDigit(m, n-1) + " " + n;
    
//     return res;
// }
// string result = NaturDigit(1, 5);
// Console.WriteLine(result);

//------------------------------------------------------------------------------------------

// Напишите прогр к-я будет принимать на вход число и возвращать сумму его цифр
...
// Напишите прогр к-я на вход принимает два числа - a и b, и возводит число a в целую степень b рекурсией
